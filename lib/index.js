...
export default class LinkedInModal extends React.Component {
    constructor() {
        ...
        this.renderButton = () => {
            ...
            if (renderButton) {
                return (React.createElement(TouchableOpacity, { accessibilityComponentType: 'button', accessibilityTraits: ['button'], onPress: this.open, hitSlop: areaTouchText, disabled: isDisabled }, renderButton()));
            }
            return (React.createElement(TouchableOpacity, { accessibilityComponentType: 'button', accessibilityTraits: ['button'], onPress: this.open, hitSlop: areaTouchText, disabled: isDisabled },
        ...
        this.renderWebview = () => {
            ...
            return (React.createElement(WebView, { source: { uri: this.getAuthorizationUrl() }, onNavigationStateChange: this.onNavigationStateChange, startInLoadingState: true, javaScriptEnabled: true, domStorageEnabled: true, injectedJavaScript: this.props.injectedJavaScript, sharedCookiesEnabled: true, incognito: true }));
        };
    }
